...
import { reportTable6 } from "helpers/constants";
...
const FnOSample = () => {
  ...
  return (
    <>
      ...
      >
        <Breadcrumbs link="Reports" Breadcrumb=" FnO PnL sample " />
      </Box>
