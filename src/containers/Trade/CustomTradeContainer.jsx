...
import ImportDrawer from "components/Trade/customPortfolio/customImportDrawer";
        ...
        <Stack direction="row" justifyContent="space-between" sx>
          <Box>
            <Text variant="body1" sx={{ fontWeight: 500, color: "#101828" }}>
              Custom <Chip label="200 Trades"></Chip>
            </Text>
  ...
  return (
    <>
      <SideDrawer
        ...
        handleSubmit={handleCustomFilterDrawer}
...
export default CustomTradeContainer;
