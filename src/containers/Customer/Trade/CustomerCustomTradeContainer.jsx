...
import {  customerCustomColumns,CustomerCustomTableRows } from "helpers/constants";
        ...
        <Box sx={{ p:1 }}>
				<Stack direction="row" justifyContent="space-between" sx={{mb:"24px"}}>
					<Box>
						...
						Here you can view Custom performance of all the family members.
						</Text>
					</Box>
						<AddFilterBtn
...
const CustomerCustomTradeContainer = () => {
	...
	return (
		<>
			...
			<Box mt={2.5} mb={4}>
				<CustomDataGrid
					autoHeight
					list={CustomerCustomTableRows}
					columnHeaderHeight={46}
					rowHeight={46}
					columns={customerCustomColumns}
					count={CustomerCustomTableRows.length}
					pagination={false}
					isLoading={false}
					isCalled={true}
...
export default CustomerCustomTradeContainer;
